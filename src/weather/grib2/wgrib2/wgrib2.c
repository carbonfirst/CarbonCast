...
//		    if (i == 0) fprintf(stderr,"gctpc_get_lat used\n");
	...
	if (decode) {
		    ...
		    last_message |= DELAYED_GRID_SIZE_ERR;
                    if (decode) fatal_error_uu("inconsistent number of bitmap points sec3-sec5: %u sec6: %u",
		    ...
		    last_message |= DELAYED_GRID_SIZE_ERR;
                    if (decode) fatal_error_uu("inconsistent number of data points sec3: %u sec5: %u",
