...
/* changed Manfred Schwarb void user_read_data(png_structp , png_bytep , png_uint_32 ); */
void user_read_data(png_structp , png_bytep , png_size_t );

/* changed Manfred Schwarb void user_read_data(png_structp png_ptr,png_bytep data, png_uint_32 length) */
