...
$Id: fort-nc4.c,v 1.39 2008/06/10 18:39:35 ed Exp $
*/
...
FCALLSCFUN4(NF_INT, nc_def_var_chunking, NF_DEF_VAR_CHUNKING, nf_def_var_chunking,
...
FCALLSCFUN4(NF_INT, nc_def_var_fill, NF_DEF_VAR_FILL, nf_def_var_fill,
	    NCID, VARID, FINT2CINT, PCINT2FINT)
...
FCALLSCFUN4(NF_INT, nc_inq_var_chunking, NF_INQ_VAR_CHUNKING, nf_inq_var_chunking,
