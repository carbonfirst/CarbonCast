/* This is part of the netCDF package. Copyright 2005 University
   ...
   $Id: tst_dims.c,v 1.20 2008/04/23 17:01:35 ed Exp $
*/
#include <config.h>
#include "netcdf.h"
#include <nc_tests.h>
...
#define MAX_ATT_LEN 80
   {
	 ...
	 ERR;
      ...
      if ((retval = nc_def_dim(ncid, LAT_NAME_EX, NLAT, &lat_dimid)))
	 ERR;
      if ((retval = nc_def_dim(ncid, LON_NAME_EX, NLON, &lon_dimid)))
	 ERR;

      /* Define a coordinate var. */
      if ((retval = nc_def_var(ncid, LON_NAME_EX, NC_FLOAT, 1, &lon_dimid,
			       &lon_varid)))
	 ERR;
