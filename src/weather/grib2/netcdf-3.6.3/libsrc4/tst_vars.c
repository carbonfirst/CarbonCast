/* This is part of the netCDF package.
   ...
   $Id: tst_vars.c,v 1.33 2008/05/15 19:42:43 ed Exp $
*/
...
create_4D_example(char *file_name, int cmode) 
{
    ...
    * data. */
   if ((retval = nc_def_var(ncid, PRES_NAME, NC_FLOAT, NDIMS_EX, 
			    dimids, &pres_varid)))
      ERR;
   if ((retval = nc_def_var(ncid, TEMP_NAME, NC_FLOAT, NDIMS_EX, 
			    dimids, &temp_varid)))
      ERR;
