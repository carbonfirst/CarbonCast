 ...
 *   $Header: /upc/share/CVS/netcdf-3/ncdump/vardata.c,v 1.37 2008/04/23 22:05:01 russ Exp $
 *********************************************************************/
...
print_any_att_val (
    ...
    sout_len = (*typ->typ_tostring)(typ, sb, valp);
}
	    ...
	    )
{
	...
	sout_len = (*varp->val_tostring)(varp, sb, valp);
    }
}
