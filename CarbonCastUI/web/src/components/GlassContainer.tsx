...
const GlassContainer = forwardRef<HTMLDivElement, GlassContainerProps>(
  ({ className, children, backdropClassName, ...props }, reference) => (
    <div
      ref={reference}
      className={twMerge(
        `relative z-30 w-full overflow-hidden border border-neutral-200 bg-white dark:border-neutral-700/60 dark:bg-neutral-900 sm:rounded-2xl sm:bg-white/80 sm:dark:bg-neutral-900/80`,
        className
      )}
      {...props}
    >
